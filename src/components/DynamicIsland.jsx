      ...
      <div className="island-inner">
        ...
        <div className="island-info">
          ...
          <div className="island-subtitle">
            {totalCount === 0 ? '就绪' : `${activeCount} 工作中 · ${completedCount} 已完成`}
          </div>
        </div>

        {/* Right: Status dots + WeChat indicator */}
            ...
            <div className="session-dots">
              {sessions.slice(0, 4).map((s, i) => (
                <span
                  ...
                  className="dot"
                  style={{
                    backgroundColor: STATUS_COLORS[s.status] || STATUS_COLORS.disconnected,
              ...
              {totalCount > 4 && (
                <span className="dot-more">+{totalCount - 4}</span>
              )}
            </div>
          )}
